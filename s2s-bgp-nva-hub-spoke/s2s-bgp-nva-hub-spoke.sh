...
az network vnet-gateway create -g $rg -n $hub1_vnet_name-gw -l $location1 --public-ip-addresses "$hub1_vnet_name-gw0" "$hub1_vnet_name-gw1" --vnet $hub1_vnet_name --gateway-type vpn --sku VpnGw2AZ --vpn-gateway-generation Generation2 --vpn-gateway-generation Generation2 --vpn-type routebased --asn $hub1_gw_asn --no-wait 
