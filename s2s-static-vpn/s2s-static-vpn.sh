...
az network public-ip create -g $rg -n $hub1_vnet_name-gw -l $location1 --allocation-method Static --sku Standard --tier Regional --zone 1 2 3 -o none
az network vnet-gateway create -g $rg -n $hub1_vnet_name-gw --public-ip-addresses $hub1_vnet_name-gw --vnet $hub1_vnet_name --sku VpnGw2AZ --vpn-gateway-generation Generation2 --vpn-gateway-generation Generation2 --vpn-gateway-generation Generation2 --gateway-type Vpn --vpn-type RouteBased --no-wait
